...
Like the meager and null sets, the class of $\sigma$-compact sets is closed under countable unions. While the class of $\sigma$-compact sets is not closed under subsets, if we wish we can instead consider the class of subsets of $\sigma$-compact sets. In a moment we will show that the whole Baire space $\omega^\omega$ is not $\sigma$-compact, so that $\sigma$-compactness really is a meaningful notion of a small set.
