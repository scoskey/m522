...
\begin{exercise}
  ...
  Let $\mathcal G\subset\Fn(\kappa,\omega)$ be uncountable. Show that $\mathcal F=\set{\dom(f)\mid f\in\mathcal G}$ is countable.
\end{exercise}
