...
\begin{exercise}
  \label{ex:domcountable}
  Let $\mathcal G\subset\Fn(\kappa,\omega)$ be uncountable. Show that if $\mathcal F=\set{\dom(f)\mid f\in\mathcal G}$ is countable, then $\mathcal G$ contains a pair of compatible elements.
\end{exercise}
