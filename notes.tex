...
We begin by showing that $\Fn(\kappa,\omega)$ enlarges $\mathfrak d$ to $\kappa$. This improves the result of Theorem~\ref{thm:ch-exact}, which showed that $\mathfrak c$ was enlarged to $\kappa$.
