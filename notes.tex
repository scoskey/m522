...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter*{Part II: Cardinal characteristics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\chapter*{Part III: Le tour de forcing}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\chapter*{Part IV: Forcing and cardinal characteristics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{proof}
  Let $f$ be an element of $\omega^\omega$ in $V[G]$, and let $\dot f$ be a name for $f$. We will show that in fact $f$ lies in $V$. To begin, use the forcing theorem to find $p\in G$ such that $p\forces$ ``$f$ is a function from $\omega$ to $\omega$''. Then in particular $p\forces(\exists n)f(0)=n$, and so by Lemma~\ref{lem:forcing-exists} there exists $p_1\leq p$ and $n_1\in\omega$ such that $p_1\forces f(0)=\check n$. (Note that we can choose a check name $\check n$ in this case.)
