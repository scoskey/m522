...
\begin{proof}
  It is elementary to prove this by induction on the complexity of the formula $\phi$. If $\phi$ is of the form $\sigma\in\tau$ or $\tau\neq\tau'$ then this property is clear from the first two clauses of Definition~\ref{defn:forces_0}. Moreover it is clear from the remaining three clauses that it is preserved to compound formulas.
\end{proof}
