...
\begin{lem}
  Assume that $\mathcal I$ is a proper $\sigma$-ideal such that $\mathcal I$ contains the singletons and $\mathcal I$ has a basis consisting of Borel sets. Then each of the four cardinals above is uncountable and bounded above by $\mathfrak c$.
\end{lem}
...
\begin{figure}[h]
  \begin{tikzpicture}
    ...
    \draw[<-] (Cof) to node {} (C);
  \end{tikzpicture}
  \caption{The relationships between the cardinal characteristics of $\mathcal I$, assuming $\mathcal I$ satisfies the hypotheses of the two lemmas. In the figure, the $\leftarrow$ symbol represents $\leq$.\label{fig:ideal}}
\end{figure}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Category versus measure: Cicho\'n's diagram}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
