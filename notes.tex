...
In this section we give a more rigorous set-theoretic definition of the $\aleph$ numbers. First, it is necessary to describe the ordinals, which appear as the subscripts $\aleph_\alpha$. While cardinals like $\aleph_3$ measure the \emph{size} of a set, ordinals like $\alpha$ measure the \emph{position} in an enumeration.
