...
For the rest of this section, and for the next few, we take up the proof of Theorem~\ref{thm:cichon}. We have already established seven out of the fifteen: $\mathfrak b\leq\mathfrak d$ follows from Proposition~\ref{prop:bd}. The two bounds $\aleph_1\leq\add(\mathcal N)$ and $\cof(\mathcal N)\leq\mathfrak c$ follow from Lemma~\ref{lem:ideal-cards}. And four more of the inequalities are special cases of Lemma~\ref{lem:diamond}. We conclude this section wih three more easy ones.
...
\begin{proof}
  This is a direct consequence of our observation in Remark~\ref{rem:ksigma-meager} that $\mathcal K_\sigma\subset\mathcal M$.
\end{proof}
...
The remaining five inequalities will be handled in the next several sections.
...
\begin{exerc}
  Show directly that $\cov(\mathcal M)\leq\mathfrak d$ (we will also prove it in the next section).
\end{exerc}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Morphisms and duality}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
