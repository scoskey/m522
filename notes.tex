...
The definitions of $\PP$-name and of $\tau_G$ are heavily recursive, but one should expect this from such a general set-theoretic construction. It is an amazing fact that such a short construction actually works, and it will take us some time to prove everything we need.

% discuss meaning of name
% mention the probability intuition thing
