...
\begin{defn}
  If $\mathbb P$ is a partial order in $V$, $\tau$ is a $\mathbb P$-name, and $G\subset\mathbb $ is a filter, then we define $\tau_G$ recursively by
...
\begin{defn}
  ...
  \begin{itemize}
  \item The \emph{forcing language} for $\mathbb P$ consists of the usual logical symbols, $\in$, and the $\PP$-names as constant symbols.
