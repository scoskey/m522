...
\begin{defn}
A family $\mathcal{D}\subseteq \omega^\omega$ is \underline{dominating} if, for all $f\in \omega^\omega$ there exists a $g\in D$ with $f\leq^* g$. The cardinal $\mathfrak{d}$, known as the dominating number, is the smallest cardinality of any dominating family: $\mathfrak{d}=\min\{|\mathcal{D}|:\mathcal{D} \text{ is dominating }\}$.
\end{defn}


\begin{defn}
A family $\mathcal{B} \subseteq \omega^\omega$ is \underline{unbounded} if there is no single $f\in \omega^\omega$ such that $g\leq^* f$ for $g\in \mathcal{B}$. The cardinal $\mathfrak{b}$, known as the bounding (or unbounding) number, is the smallest cardinality of any unbounded family: $\mathfrak{b}=\min\{ |\mathcal{B}|: \mathcal{B} \text{ is unbounded }\}$.
\end{defn}


\begin{thm}
  $\aleph_1\leq \mathfrak{b}\leq \mathfrak{d}\leq \mathfrak{c}.$ \end{thm}
