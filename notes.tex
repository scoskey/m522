...
For the rest of this section, and for the next few, we concern ourselves with the proof of Theorem~\ref{thm:cichon}. We have already established five out of the fifteen: $\aleph_1\leq\add(\mathcal N)$ and $\cof(\mathcal N)\leq\mathfrak c$ both follow from Lemma~\ref{lem:ideal-cards}, and $\add(\mathcal M)\leq\cov(\mathcal M)$ and $\non(\mathcal M)\leq\cof(\mathcal M)$ both follow from Lemma~\ref{lem:diamond}. Finally $\mathfrak b\leq\mathfrak d$ follows from Proposition~\ref{prop:bd}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Further proofs of Cicho\'n's diagram}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
