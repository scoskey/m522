...
So far we have seen many similarities between the various size notions that we have discussed. The classes of meager sets, null sets are both ideals, both proper, both closed under countable unions, and so on. It is natural to ask whether the meager and null sets are truly different notions. The following 
...
We will begin the proof of this theorem now, and continue it over the next few sections. We have already established several of the inequalities: $\add(\mathcal M)\leq\cov(\mathcal M)$ and $\non(\mathcal M)\leq\cof(\mathcal M)$ both follow from [ref] and $\mathfrak b\leq\mathfrak d$ follows from [ref].
