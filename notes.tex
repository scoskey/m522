...
\begin{prop}
  In the definition of MA, we cannot in general allow $\mathcal F$ to be of size continuum.
\end{prop}
...
We sometimes consider the refinements of MA defined as follows. The axiom MA$_\kappa$ states
...
\begin{thm}
  Assuming MA, we have $\add(\Null)=\mathfrak c$. Hence all the cardinal characteristics in Cicho\'n's diagram are equal, but possibly larger than $\aleph_1$.
\end{thm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\section{Nuts and bolts of forcing}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
